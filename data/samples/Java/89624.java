...
public class Dcm2Jpg {
    ...
    public int mconvert(String[] args, int optind, File destDir, byte[] lut) throws IOException {
        int count = 0;
    ...
    */
    public static void main(String args[]) throws Exception {
        ...
        if (dest.isDirectory()) {
            ...
            if (argc > optind + 2 || src.isDirectory()) {
                exit("dcm2jpg.jar: when converting several files, " + "last argument must be a directory\n");
            }
    ...
    private static final String USAGE = "Usage: java -jar dcm2jpg.jar [-lut LUT] SOURCE DEST\n" + "    or java -jar dcm2jpg.jar [-lut LUT] SOURCE... DIRECTORY\n\n" + "Convert DICOM image(s) to JPEG(s).\n\n";
}
