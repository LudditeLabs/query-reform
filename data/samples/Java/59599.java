...
public class GetTimeStamps {
    ...
    public boolean setArgs(String[] args) {
        ...
        if (useEnd) {
            if (start > end) {
                System.out.println("End time (" + end + ") must come after start (" + start + ")");
                return false;
            }
            duration = end - start;
        }
        if (!(type.equals("absolute") || type.equals("newest") || type.equals("oldest") || type.equals("aligned") || type.equals("after") || type.equals("modified") || type.equals("next") || type.equals("previous"))) {
        ...
        if (verbose) {
            ...
            System.out.println("  Times: start = " + start + "; duration = " + duration + "; type = " + type);
    ...
    public static double getTimeOrDouble(String arg) throws Exception {
        ...
        if (!gotit) throw (new Exception("Failed to parse time " + arg + "; exception:" + reason));
        return value;
    }
}
